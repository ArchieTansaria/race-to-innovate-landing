		...
		<section className="min-h-screen pt-28 pb-16 px-4 flex items-center justify-center relative overflow-hidden">
			...
			<div className="container mx-auto max-w-6xl">
				<div className="flex flex-col lg:flex-row items-center gap-12">
					<div className="flex-1 space-y-6 text-center lg:text-left">
						<div className="animate-fade-in">
							...
							<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight">
								Race to{" "}
								<span className="text-hackathon-purple">
									Innovate
								</span>
								<br />
								<span className="text-3xl md:text-4xl lg:text-5xl text-hackathon-aqua font-normal">
									The Design Run
								</span>
							</h1>
							<p className="mt-6 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto lg:mx-0">
								Unleash your creativity, solve design riddles,
								and develop innovative prototypes in this unique
								hackathon experience
							</p>
						</div>

						<div
							className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4 animate-fade-in"
							style={{
								animationDelay: "0.2s",
							}}
						>
							<a
								href="#registerhttps://unstop.com/competitions/race-to-innovate-geekmayhem-2025-nitte-meenakshi-institute-of-technology-nmit-yelahanka-1422546"
						...
						<div
							className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-8 pt-6 animate-fade-in"
							style={{
								animationDelay: "0.4s",
							}}
						>
					...
					<div
						className="flex-1 w-full max-w-md animate-fade-in"
						style={{
							animationDelay: "0.6s",
						}}
					>
						<div className="glass-dark p-6 rounded-2xl shadow-2xl border border-white/10 backdrop-blur-xl bg-black/[0.71]">
							<h3 className="text-xl font-semibold mb-6 text-center text-slate-50">
							...
							<div className="p-4 rounded-xl text-white text-sm bg-[s] bg-[#7700ff]">
								<h4 className="font-semibold mb-2">
									Shortlisting Round is Live!
								</h4>
								<p className="opacity-80">
									Submit your entry via Unstop before March
									23, 2025, 11:59 PM IST to qualify for the
									finals.
								</p>
							</div>
						</div>
